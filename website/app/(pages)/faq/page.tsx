            ...
            <ul className="flex flex-col max-h-[83%] gap-5 sm:max-h-[93%] bg-gray-700 p-4 rounded-3xl overflow-auto">
              <li>
                ...
                <p className="ml-6 font-light">
                  {`I started developing this site because of my passion for discovering small
  and up-and-coming artists. It’s also a bit of a way to show off to my friends—
  providing proof that I knew about certain artists before they became well-known! 
  So if you're like me and you enjoy seeing how an artist’s popularity grows, I hope 
  you'll find this website useful. This site is designed to track artists' follower 
  counts over time. Currently, the stats are pulled from Spotify's public API. 
  Depending on interest, I may add more statistics from YouTube and other social 
  media platforms in the future.`}
              ...
              <li>
                ...
                <p className="ml-6 font-light">
                  ...
                  musipster accounts, there will initially be only one data
                  point. More data points will be added daily at 12:00 AM UTC.
                  You may notice that the second data point is the same as the
                  first; this is due to the design of the backend/database.
                  However, after the first two days, the chart should accurately
                  reflect artist growth with different values (unless they do
                  not gain or lose followers).`}
                </p>
              </li>
              {/* <li>

            ...
            <ul className="flex flex-col gap-5 max-h-[93%] bg-gray-700 p-4 rounded-3xl overflow-auto">
              <li>
                ...
                <p className="ml-6 font-light">
                  ...
                  grows, I hope you'll find this website useful.
                  This site is designed to track artists' follower counts over time.
              ...
              <li>
                ...
                <p className="ml-6 font-light">
                  To get started, navigate to the "My Artists" section in the
                  sidebar. From there, you can add any artists you wish to track
                  and monitor their follower growth over time. After adding an
                  artist, go to the "Dashboard" to view their follower count. If
                  you are the first person to add an artist to your list, there
                  will initially be only one data point. More data points will
                  be added daily at 12:00 AM UTC. You may notice that the second
                  data point is the same as the first; this is due to the design
                  of the backend/database. However, after the first two days,
                  the chart should accurately reflect artist growth with
                  different values (unless they do not gain or lose followers).
                </p>
              </li>
              <li>
              ...
              <li>
                ...
                <p className="ml-6 font-light">
                  I've been thinking about whether or not to accomodate for this.
                  If I were to add a way to sync your Spotify profile to your account,
                  I would most likely need to also do the same for other platforms likely
                  YouTube, Soundcloud, Apple Music, etc. As of now, I do not have any plans
                  to accomodate for this just yet, but likely in the future.
                </p>
              </li>
              <li>
                <h2 className="font-bold">
                  What?! None of these 4 answers answered your
                  question?
                </h2>
                <p className="ml-6 font-light">
